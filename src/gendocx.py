...
def gen_doc(title, author):
    ...
    document.add_paragraph('author:{} '.format(author))
    document.add_paragraph('date:{}'.format(__date__))
    document.add_paragraph('\n')

    return document


def doc_append_table(doc, tb_info, tb_name):
    """
    ...
    tbinfo_cells[0].text = '表名:{}'.format(tb_name)
